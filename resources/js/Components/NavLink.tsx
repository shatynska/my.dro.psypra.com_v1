...
export default function NavLink({ active, href, children }: PropsWithChildren<Props>) {
    const classes = active
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-primary-600 text-sm font-medium leading-5 text-slate-900 focus:outline-none focus:border-primary-700 transition'
